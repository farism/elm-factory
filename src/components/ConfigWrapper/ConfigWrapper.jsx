...
export default class ConfigWrapper extends PureComponent {
  ...
  _getDefaultDoc = () => {
    const extra = this.props.router.params.extra
    switch (extra) {
      case 'secure':
        return (
          <div>
            ...
            <p>
              ...
              properties can be configed as an environment variable instead of
              in your config object. You simply take the "path" of the config
      ...
      case 'templating':
        return (
          <div>
            ...
            <p>
              For lots of your config you might find yourself duplicating words
              or phrases, for instance your application name would be used in
              several places. This makes it much harder to change this value as
              you have to change it in several places and be certain you don't
              miss any.
            </p>
            <p>
            ...
            <p>
              ...
              package.json's "productName" property as the name for your
              packaged app.
            </p>
          </div>
        )
        ...
        return (
          <div>
            ...
            <p>
              ...
              properties check out their docs in the properties menu on the
              left.
            </p>
          </div>
        )
